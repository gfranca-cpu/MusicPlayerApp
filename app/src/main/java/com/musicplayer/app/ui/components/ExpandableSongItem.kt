...
fun ExpandableSongItem(
    ...
    BoxWithConstraints(
        ...
        // Área aproximada do texto do título, dentro da Row (padding 16dp + avatar 56dp + spacer 12dp até o início do texto;
        // padding 16dp + ícone 24dp até o fim do texto)
        val textStartXPx = with(density) { (16.dp + 56.dp + 12.dp).toPx() }
        val textEndXPx = with(density) { (maxWidth - 16.dp - 24.dp).toPx() }
                    ...
                    awaitEachGesture {
                        ...
                        while (true) {
                            ...
                            if (!event.changes.any { it.pressed }) {
                                ...
                                } else if (isHighlighted && down.position.x in textStartXPx..textEndXPx) {
                                    currentOnPlaySong()
                                }
                                break
                            }
